...
function Cart({ user }) {
    ...
    const cart = allcart.filter(item => item.layout === 'pharmacie');
      ...
      <View style={styles.container}>
        <StackAppbar title="Mon panier" styles={{ bgColor: colors.primary, textColor: 'white' }} goBack={navigation.goBack}/>
           ...
           <View style={styles.about}>
            <Text style={styles.aboutText}>{cart.length} médicaments  sélectionnés</Text>
            <View style={styles.amountContainer}>
            ...
            </View>
             {
                ...
                <TouchableOpacity style={styles.commandeButton} onPress={() => navigation.navigate('medico-commande-form', { cart , amount })}>
                    <Text style={styles.commandeButtonText}>Commander</Text>
                </TouchableOpacity>
            </View>: <View style={styles.commandeContainer}>
                <TouchableOpacity style={styles.commandeButton} onPress={() => navigation.navigate('medicaments-list', { data: {title: 'Les menus'} })}>
