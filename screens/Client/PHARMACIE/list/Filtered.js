...
import MedicamentsList from '../../../../components/PHARMACIE/list/MedicamentsList';

function MedicoFiltered({user}) {
  ...
  useEffect(() => {
    ...
    return (
        <>
          ...
          {
            filtered.id === "1" &&  (
                <MedicamentsList user={user} promo={true} adresse={address.ville}  />
            )
          }
          
          {
            filtered.id === "2" &&  (
                <MedicamentsList user={user} adresse={address.ville}  />
            )
          }
