...
function MedicoCommandeForm({ user }) {
...
const handleSubmit = ()=>{
            ...
            if (selectedPayment==='mainAccount') {
              ...
              setLoading(true)
                 ...
                 handlePayByMomo(amount , phoneNumber , user , setLoading , 'Achat de médicaments' , (data)=>{
 ...
 const uploadFile = async (source) => {
    ...
    try {
      const response = await takePhoto(source, 'images/pieces/' + user._id);
        ...
        <View style={styles.modalContainer}>
            ...
            <TouchableOpacity onPress={() => !imageLoading && uploadFile('camera')}>
              <View style={styles.secondaryBtn}>
                <Text style={styles.secondaryBtnText}>
                  {imageLoading ? <ActivityIndicator color={colors.secondary} size={20}/> : 'Utiliser la caméra'}
                </Text>
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.formAction}>
            <TouchableOpacity onPress={() => !imageLoading && uploadFile('library')}>
              <View style={styles.secondaryBtn}>
                <Text style={styles.secondaryBtnText}>
                  {imageLoading ? <ActivityIndicator color={colors.secondary} size={20}/> : 'Utiliser votre galerie'}
                </Text>
              </View>
            </TouchableOpacity>
          </View>
...
export default MedicoCommandeForm;
